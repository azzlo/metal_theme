...
/*Template Name: contacto*/
 ...
 <?php get_header();?>
  ...
  43996 Cd Sahagún, Hgo.
      ...
      <div class="col-md-6">
        <form class="formulario" action="http://localhost/wordpress/wp-content/themes/metal_theme/enviar.php" method="post">
          ...
          <input class="inputFormulario"type="submit" name="envir" value="Enviar" id="botonn">
        </form>
      </div>
  </div>
</div>
